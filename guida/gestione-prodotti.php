...
<div class="generale">
	...
	<div class="contenutoguida">
		...
		<h2 id="2">2. Gestione dei Prodotti</h2><hr>
		<div class="boxguida">
			...
			<center><img src="img/visualizza_prodotti.jpg"></center><br /><br />
			...
			<h2 id="2.1">2.1 Aggiungere un nuovo Prodotto</h2><hr>
			Per inserire un nuovo prodotto, la procedura &egrave; semplice:<br /><br />
			<center><img src="img/aggiungi_prodotto.jpg"></center><br /><br />
			...
			<center><img src="img/carica_img.jpg"></center><br /><br />
			...
			<center><img src="img/altremisure.jpg"></center><br /><br />
			...
			<center><img src="img/offerta.jpg"></center><br /><br />
			...
			<h2 id="2.3">2.3 Eliminare un prodotto</h2><hr>
			...
			<h2 id="2.4">2.4 Bloccare un prodotto</h2><hr>
			...
			<img src="img/blocca.jpg"><br /><br />
			<div class="torna"><a href="#indice">[Torna su]</a></div>
			<p>&nbsp;</p><p>&nbsp;</p>
			
			<h2 id="2.5">2.5 Sbloccare un prodotto</h2><hr>
