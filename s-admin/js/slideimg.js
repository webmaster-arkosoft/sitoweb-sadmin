 ...
 if(!(params.width>0 && isFinite(params.width)))params.width=150;
  if(!(params.height>0 && isFinite(params.height)))params.height=760;
  ...
  function init(){
    ...
    for(var i=0;i<params.images.length;i++){
		...
		images[i].src=params.images[i];
			  ...
			  images[i].onclick=new Function("caricapagina("+i+"); oscura();");
